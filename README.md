...
На странице карточки произведения можно добавить произведение в список просмотренного/отслеживаемого и оставить отзыв на это произведение, отзыв можно отредактировать или удалить.
